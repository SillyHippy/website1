...
namespace Tenweb_Builder\Widgets\Hotspot;
...
class Hotspot extends Widget_Image {
	...
	public function get_name() {
		return Builder::$prefix . '_hotspot';
	}

	public function get_title() {
		return esc_html__( 'Hotspot', 'tenweb-builder' );
	}
	...
	public function get_icon() {
		return 'twbb-hotspot twbb-widget-icon';
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'hotspot_section',
			[
				'label' => esc_html__( 'Hotspot', 'tenweb-builder' ),
			]
		);
		...
		$repeater->add_control(
			...
			[
				...
				'options' => [
					'start' => [
						'title' => esc_html__( 'Icon Start', 'tenweb-builder' ),
						'icon' => 'eicon-h-align-left',
					],
					'end' => [
						'title' => esc_html__( 'Icon End', 'tenweb-builder' ),
		...
		$repeater->add_control(
			'hotspot_custom_size',
			[
				'label' => esc_html__( 'Custom Hotspot Size', 'tenweb-builder' ),
				'type' => Controls_Manager::SWITCHER,
				'label_off' => esc_html__( 'Off', 'tenweb-builder' ),
				'label_on' => esc_html__( 'On', 'tenweb-builder' ),
				'default' => 'no',
				'description' => esc_html__( 'Set custom Hotspot size that will only affect this specific hotspot.', 'tenweb-builder' ),
			]
		);

		$repeater->add_control('hotspot_width',
			[
				'label' => esc_html__( 'Min Width', 'tenweb-builder' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 0,
		...
		$repeater->add_control(
			'hotspot_height',
			[
				'label' => esc_html__( 'Min Height', 'tenweb-builder' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 0,
		...
		$repeater->add_control(
			...
			[
				...
				'label' => esc_html__( 'Tooltip Content', 'tenweb-builder' ),
				'type' => Controls_Manager::WYSIWYG,
				'default' => esc_html__( 'Add Your Tooltip Text Here', 'tenweb-builder' ),
			]
		);
		...
		$repeater->add_control(
			'hotspot_horizontal',
			[
				'label' => esc_html__( 'Horizontal Orientation', 'tenweb-builder' ),
				'type' => Controls_Manager::CHOOSE,
		...
		$repeater->add_control(
			'hotspot_vertical',
			[
				'label' => esc_html__( 'Vertical Orientation', 'tenweb-builder' ),
				'type' => Controls_Manager::CHOOSE,
				'options' => [
					'top' => [
		...
		$repeater->add_control(
			...
			[
				'label' => esc_html__( 'Custom Tooltip Properties', 'tenweb-builder' ),
				'type' => Controls_Manager::SWITCHER,
				'label_off' => esc_html__( 'Off', 'tenweb-builder' ),
				'label_on' => esc_html__( 'On', 'tenweb-builder' ),
				'default' => 'no',
				'description' => sprintf( esc_html__( 'Set custom Tooltip opening that will only affect this specific hotspot.', 'tenweb-builder' ), '<code>|</code>' ),
			]
		);
		...
		$repeater->add_control(
			...
			[
				'label' => esc_html__( 'Text Wrap', 'tenweb-builder' ),
				'type' => Controls_Manager::SWITCHER,
				'label_off' => esc_html__( 'Off', 'tenweb-builder' ),
				'label_on' => esc_html__( 'On', 'tenweb-builder' ),
				'selectors' => [
		...
		$this->add_control(
			...
			[
				...
				'title_field' => '{{{ hotspot_label }}}', //phpcs:ignore WordPressVIPMinimum.Security.Mustache.OutputNotation
				'default' => [
					[
						// Default #1 circle
					],
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					'e-hotspot--soft-beat' => esc_html__( 'Soft Beat', 'tenweb-builder' ),
					'e-hotspot--expand' => esc_html__( 'Expand', 'tenweb-builder' ),
					'e-hotspot--overlay' => esc_html__( 'Overlay', 'tenweb-builder' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Sequenced Animation', 'tenweb-builder' ),
				'type' => Controls_Manager::SWITCHER,
				'label_off' => esc_html__( 'Off', 'tenweb-builder' ),
				'label_on' => esc_html__( 'On', 'tenweb-builder' ),
				'default' => 'no',
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Sequence Duration (ms)', 'tenweb-builder' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 100,
		...
		$this->start_controls_section(
			'tooltip_section',
			[
				'label' => esc_html__( 'Tooltip', 'tenweb-builder' ),
			]
		);
		...
		$this->add_responsive_control(
			'tooltip_trigger',
			[
				'label' => esc_html__( 'Trigger', 'tenweb-builder' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'mouseenter' => esc_html__( 'Hover', 'tenweb-builder' ),
					'click' => esc_html__( 'Click', 'tenweb-builder' ),
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::SELECT,
				'options' => [
					'e-hotspot--fade-in-out' => esc_html__( 'Fade In/Out', 'tenweb-builder' ),
					'e-hotspot--fade-grow' => esc_html__( 'Fade Grow', 'tenweb-builder' ),
					'e-hotspot--fade-direction' => esc_html__( 'Fade By Direction', 'tenweb-builder' ),
					'e-hotspot--slide-direction' => esc_html__( 'Slide By Direction', 'tenweb-builder' ),
				],
				'default' => 'e-hotspot--fade-in-out',
				'placeholder' => esc_html__( 'Enter your image caption', 'tenweb-builder' ),
				'condition' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Duration (ms)', 'tenweb-builder' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 0,
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Box Color', 'tenweb-builder' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
...
\Elementor\Plugin::instance()->widgets_manager->register(new Hotspot());
