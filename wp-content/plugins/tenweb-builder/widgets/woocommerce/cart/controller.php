...
class Cart extends Base_Widget {
    ...
    public function get_name() {
        return 'twbb_woocommerce-cart';
    }

    public function get_title() {
        return esc_html__( 'Cart', 'tenweb-builder' );
    }

    public function get_icon() {
        return 'twbb-cart twbb-widget-icon';
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'description' => esc_html__( 'This option will allow the right column (e.g, Cart Totals) to be sticky while scrolling.', 'tenweb-builder' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'label' => esc_html__( 'Update Cart Button', 'tenweb-builder' ),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'placeholder' => esc_html__( 'Update Cart', 'tenweb-builder' ),
                'default' => esc_html__( 'Update Cart', 'tenweb-builder' ),
            ]
        );
        ...
        if ( $this->is_wc_feature_active( 'coupons' ) ) {
            ...
            $this->add_control(
                ...
                [
                    'type' => Controls_Manager::HEADING,
                    'label' => esc_html__( 'Apply Coupon Button', 'tenweb-builder' ),
                    'condition' => [
            ...
            $this->add_control(
                ...
                [
                    ...
                    'placeholder' => esc_html__( 'Apply coupon', 'tenweb-builder' ),
                    'default' => esc_html__( 'Apply coupon', 'tenweb-builder' ),
                    'condition' => [
                        'section_coupon_display' => 'yes',
                    ],
                ]
        ...
        $this->start_controls_section(
            'section_totals',
            [
                'label' => esc_html__( 'Totals', 'tenweb-builder' ),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'placeholder' => esc_html__( 'Cart Totals', 'tenweb-builder' ),
                'default' => esc_html__( 'Cart Totals', 'tenweb-builder' ),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'type' => Controls_Manager::HEADING,
                'label' => esc_html__( 'Update Shipping Button', 'tenweb-builder' ),
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'placeholder' => esc_html__( 'Update', 'tenweb-builder' ),
                'default' => esc_html__( 'Update', 'tenweb-builder' ),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'placeholder' => esc_html__( 'Proceed to Checkout', 'tenweb-builder' ),
                'default' => esc_html__( 'Proceed to Checkout', 'tenweb-builder' ),
            ]
        );
        ...
        $this->add_control(
            'update_cart_automatically',
            [
                'label' => esc_html__( 'Update Cart Automatically', 'tenweb-builder' ),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__( 'Yes', 'tenweb-builder' ),
                'label_off' => esc_html__( 'No', 'tenweb-builder' ),
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'raw' => esc_html__( 'Changes to the cart will update automatically.', 'tenweb-builder' ),
                'type' => Controls_Manager::RAW_HTML,
                'content_classes' => 'elementor-descriptor',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Customize empty cart', 'tenweb-builder' ),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__( 'Yes', 'tenweb-builder' ),
                'label_off' => esc_html__( 'No', 'tenweb-builder' ),
                'return_value' => 'active',
        ...
        $this->add_control(
            ...
            [
                ...
                /* translators: 1: Saved templates link opening tag, 2: Link closing tag. */
                    esc_html__( 'Replaces the default WooCommerce Empty Cart screen with a custom template. (Don’t have one? Head over to %1$sSaved Templates%2$s)', 'tenweb-builder' ),
        ...
        $this->add_control(
            ...
            [
                'type' => Controls_Manager::HEADING,
                'label' => esc_html__( 'Choose template', 'tenweb-builder' ),
                'condition' => [
                    'additional_template_switch' => 'active',
                ],
            ]
        ...
        $this->add_control(
            'edit_button',
            [
                'raw' => sprintf( '<a href="#" target="_blank" class="elementor-button elementor-edit-template" style="margin-top:0px;"><i class="eicon-pencil"> %s</i></a>', esc_html__( 'Edit Template', 'tenweb-builder' ) ),
        ...
        $this->start_controls_tab( 'links_normal_colors', [ 'label' => esc_html__( 'Normal', 'tenweb-builder' ) ] );
        ...
        $this->start_controls_tab( 'links_hover_colors', [ 'label' => esc_html__( 'Hover', 'tenweb-builder' ) ] );
        ...
        $this->add_control(
            ...
            [
                'type' => Controls_Manager::HEADING,
                'label' => esc_html__( 'Field', 'tenweb-builder' ),
            ]
        );
        ...
        $this->start_controls_tab( 'forms_fields_normal_styles', [ 'label' => esc_html__( 'Normal', 'tenweb-builder' ) ] );
        ...
        $this->start_controls_tab( 'forms_fields_focus_styles', [ 'label' => esc_html__( 'Focus', 'tenweb-builder' ) ] );
        ...
        $this->start_controls_tab( 'forms_buttons_normal_styles', [ 'label' => esc_html__( 'Normal', 'tenweb-builder' ) ] );
        ...
        $this->start_controls_tab( 'forms_buttons_hover_styles', [ 'label' => esc_html__( 'Hover', 'tenweb-builder' ) ] );
        ...
        $this->start_controls_tab( 'order_summary_normal', [ 'label' => esc_html__( 'Normal', 'tenweb-builder' ) ] );
        ...
        $this->start_controls_tab( 'order_summary_hover', [ 'label' => esc_html__( 'Hover', 'tenweb-builder' ) ] );
        ...
        $this->add_control(
            ...
            [
                'type' => Controls_Manager::HEADING,
                'label' => esc_html__( 'Quantity Borders', 'tenweb-builder' ),
                'separator' => 'before',
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .twbb-minus-quantity' => 'border-width: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .twbb-plus-quantity' => 'border-width: {{SIZE}}{{UNIT}};'
                ],
            ]
        );

        $this->add_control(
            'order_summary_quantity_padding',
            [
                'label' => __('Padding', 'tenweb-builder'),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', '%', 'em', 'rem', 'vw', 'custom' ],
                'selectors' => [
                    '{{WRAPPER}} .woocommerce .quantity input' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};width: calc({{RIGHT}}{{UNIT}} + {{LEFT}}{{UNIT}} + 40px);',
                    '{{WRAPPER}} .woocommerce table.cart td.actions .quantity .input-text' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};width: calc({{RIGHT}}{{UNIT}} + {{LEFT}}{{UNIT}} + 100px);',
        ...
        $this->add_responsive_control(
            'order_summary_quantity_border_radius',
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .woocommerce .quantity input' => 'border-radius: {{SIZE}}{{UNIT}}',
                    '{{WRAPPER}} .woocommerce table.cart td.actions .quantity .input-text' => 'border-radius: {{SIZE}}{{UNIT}}',
                    '{{WRAPPER}} .woocommerce .twbb-minus-quantity' => 'border-radius: {{SIZE}}{{UNIT}}',
                    '{{WRAPPER}} .woocommerce .twbb-plus-quantity' => 'border-radius: {{SIZE}}{{UNIT}}'
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'type' => Controls_Manager::HEADING,
                'label' => esc_html__( 'Remove icon', 'tenweb-builder' ),
                'separator' => 'before',
            ]
        );
        ...
        $this->start_controls_tab( 'order_summary_remove_icon_normal', [ 'label' => esc_html__( 'Normal', 'tenweb-builder' ) ] );
        ...
        $this->start_controls_tab( 'order_summary_remove_icon_hover', [ 'label' => esc_html__( 'Hover', 'tenweb-builder' ) ] );
        ...
        $this->start_controls_tab( 'checkout_button_normal_styles', [ 'label' => esc_html__( 'Normal', 'tenweb-builder' ) ] );
        ...
        $this->start_controls_tab( 'checkout_button_hover_styles', [ 'label' => esc_html__( 'Hover', 'tenweb-builder' ) ] );
        ...
        $customize_options += [
            'customize_totals' => esc_html__( 'Totals', 'tenweb-builder' ),
        ];

        $this->add_control(
            'section_cart_show_customize_elements',
            [
                'label' => esc_html__( 'Select sections of the cart to customize:', 'tenweb-builder' ),
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Customize: Totals', 'tenweb-builder' ),
                'tab' => Controls_Manager::TAB_STYLE,
                'condition' => [
        ...
        $this->start_controls_tab( 'totals_section_links_normal_colors', [ 'label' => esc_html__( 'Normal', 'tenweb-builder' ) ] );
        ...
        $this->start_controls_tab( 'totals_section_links_hover_colors', [ 'label' => esc_html__( 'Hover', 'tenweb-builder' ) ] );
        ...
        <div class="coupon e-cart-section shop_table">
            <div class="form-row coupon-col">
                <div class="coupon-col-start">
                    <input type="text" name="coupon_code" class="input-text" id="coupon_code" value="" placeholder="<?php esc_attr_e( 'Coupon code', 'tenweb-builder' ); ?>" />
                </div>
                <div class="coupon-col-end">
                    <button <?php $this->print_render_attribute_string( 'button_coupon' ); ?> value="<?php esc_attr_e( 'Apply coupon', 'tenweb-builder' ); ?>"><?php esc_html_e( 'Apply coupon', 'tenweb-builder' ); ?></button>
                </div>
...
public function woocommerce_before_cart_collaterals() {
    ...
    public function woocommerce_get_remove_url( $url ) {
        \Elementor\Plugin::instance()->modules_manager->get_modules( 'dev-tools' )->deprecation->deprecated_function( __METHOD__, '3.7.0' );
    ...
    public function woocommerce_get_cart_url( $url ) {
        ...
        if ( \Elementor\Plugin::instance()->preview->is_preview_mode() || is_preview() || \Elementor\Plugin::instance()->editor->is_edit_mode() ) {
            return \Elementor\Plugin::instance()->documents->get_current()->get_wp_preview_url();
        }
...
\Elementor\Plugin::instance()->widgets_manager->register( new Cart() );
