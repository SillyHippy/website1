...
namespace Tenweb_Builder\Widgets\Posts_Skins\Traits;
...
trait Button_Widget_Trait {
	...
	protected function register_button_content_controls( $args = [] ) {
		$default_args = [
			'section_condition' => [],
			'button_text' => esc_html__( 'Click here', 'tenweb-builder' ),
			'control_label_name' => esc_html__( 'Text', 'tenweb-builder' ),
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'options' => [
					'' => esc_html__( 'Default', 'tenweb-builder' ),
					'info' => esc_html__( 'Info', 'tenweb-builder' ),
					'success' => esc_html__( 'Success', 'tenweb-builder' ),
					'warning' => esc_html__( 'Warning', 'tenweb-builder' ),
					'danger' => esc_html__( 'Danger', 'tenweb-builder' ),
				],
		...
		$this->add_responsive_control(
			...
			[
				...
				'options' => [
					...
					'space-between' => [
						'title' => esc_html__( 'Space between', 'tenweb-builder' ),
