<?php
namespace Tenweb_Builder\Widgets\Video_Playlist;
...
class Video_Playlist extends Widget_Base {
    ...
    public function get_name() {
        return Builder::$prefix . '_video-playlist';
    }

	public function get_title() {
		return esc_html__( 'Video Playlist', 'tenweb-builder' );
	}

	public function get_icon() {
		return 'twbb-video-playlist twbb-widget-icon';
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'section_playlist',
			[
				'label' => esc_html__( 'Playlist', 'tenweb-builder' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'vertical' => esc_html__( 'Vertical', 'tenweb-builder' ),
				],
		...
		$this->add_control(
			'playlist_title',
			[
				'label' => esc_html__( 'Playlist Name', 'tenweb-builder' ),
				'type' => Controls_Manager::TEXT,
				'default' => esc_html__( 'Playlist', 'tenweb-builder' ),
				'placeholder' => esc_html__( 'Playlist', 'tenweb-builder' ),
		...
		$repeater->add_control(
			'type',
			[
				'label' => esc_html__( 'Type', 'tenweb-builder' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'youtube',
				'options' => [
					'youtube' => esc_html__( 'YouTube', 'tenweb-builder' ),
					'vimeo' => esc_html__( 'Vimeo', 'tenweb-builder' ),
					'hosted' => esc_html__( 'Self Hosted', 'tenweb-builder' ),
					'section' => esc_html__( 'Section', 'tenweb-builder' ),
				],
			]
		);
		...
		$repeater->add_control(
			...
			[
				...
				'placeholder' => esc_html__( 'Paste URL', 'tenweb-builder' ) . ' (YouTube)',
				'label_block' => true,
				'condition' => [
					'type' => 'youtube',
				],
		...
		$repeater->add_control(
			...
			[
				...
				'placeholder' => esc_html__( 'Enter your URL', 'tenweb-builder' ) . ' (Vimeo)',
		...
		$repeater->add_control(
			...
			[
				...
				'label_block' => true,
				'text' => esc_html__( 'Get Video Data', 'tenweb-builder' ),
				'separator' => 'none',
		...
		$repeater->add_control(
			'is_external_url',
			[
				'label' => esc_html__( 'External URL', 'tenweb-builder' ),
		...
		$repeater->add_control(
			'hosted_url',
			[
				'label' => esc_html__( 'Choose File', 'tenweb-builder' ),
		...
		$repeater->add_control(
			'external_url',
			[
				'label' => esc_html__( 'URL', 'tenweb-builder' ),
				...
				'media_type' => 'video',
				'placeholder' => esc_html__( 'Enter your URL', 'tenweb-builder' ),
				'condition' => [
					'type' => 'hosted',
					'is_external_url' => 'yes',
				],
		...
		$repeater->add_control(
			...
			[
				...
				'default' => esc_html__( 'Title', 'tenweb-builder' ),
				'placeholder' => esc_html__( 'Add Your Text Here', 'tenweb-builder' ),
				'label_block' => true,
			]
		);
		...
		$repeater->add_control(
			'duration',
			[
				'label' => esc_html__( 'Duration', 'tenweb-builder' ),
				'type' => Controls_Manager::TEXT,
				'placeholder' => '1:05',
				'default' => '',
				'condition' => [
		...
		$repeater->add_control(
			'thumbnail',
			[
				'label' => esc_html__( 'Thumbnail', 'tenweb-builder' ),
				'type' => Controls_Manager::MEDIA,
				'dynamic' => [
					'active' => true,
				],
		...
		$repeater->add_control(
			...
			[
				'label' => esc_html__( 'Contents Tabs ', 'tenweb-builder' ),
				'type' => Controls_Manager::SWITCHER,
		...
		$repeater->start_controls_tab(
			'inner_tab_1',
			[
				'label' => esc_html__( 'Tab #1', 'tenweb-builder' ),
				'condition' => [
					'type' => [ 'youtube', 'hosted', 'vimeo' ],
		...
		$repeater->add_control(
			...
			[
				...
				'default' => '<p>' . esc_html__( 'Add some content for each one of your videos, like a description, transcript or external links.To add, remove or edit tab names, go to Tabs.', 'tenweb-builder' ) . '</p>',
				'condition' => [
					'type' => [ 'youtube', 'hosted', 'vimeo' ],
					'inner_tab_is_content_visible' => 'show',
				],
		...
		$repeater->start_controls_tab(
			'inner_tab_2',
			[
				'label' => esc_html__( 'Tab #2', 'tenweb-builder' ),
				'condition' => [
					'type' => [ 'youtube', 'hosted', 'vimeo' ],
					'inner_tab_is_content_visible' => 'show',
				],
		...
		$this->add_control(
			'tabs',
			[
				'label' => esc_html__( 'Playlist Items', 'tenweb-builder' ),
				'type' => Controls_Manager::REPEATER,
				'fields' => $repeater->get_controls(),
				'default' => [
					[
						'title' => esc_html__( 'Sample Video', 'tenweb-builder' ),
		...
		$this->start_controls_section(
			'section_inner_tab',
			[
				'label' => esc_html__( 'Tabs', 'tenweb-builder' ),
			]
		);
		...
		$this->add_control(
			'inner_tab_title_1',
			[
				'label' => esc_html__( 'Tab 1 Name', 'tenweb-builder' ),
				'type' => Controls_Manager::TEXT,
				'default' => esc_html__( 'Tab #1', 'tenweb-builder' ),
				'dynamic' => [
					'active' => true,
				],
				'placeholder' => esc_html__( 'Name', 'tenweb-builder' ),
				'frontend_available' => true,
			]
		);
		...
		$this->add_control(
			'inner_tab_title_2',
			[
				'label' => esc_html__( 'Tab 2 Name', 'tenweb-builder' ),
				'type' => Controls_Manager::TEXT,
				'default' => esc_html__( 'Tab #2', 'tenweb-builder' ),
				'dynamic' => [
					'active' => true,
				],
				'placeholder' => esc_html__( 'Name', 'tenweb-builder' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Collapsible', 'tenweb-builder' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Show', 'tenweb-builder' ),
				'label_off' => esc_html__( 'Hide', 'tenweb-builder' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Read More Label', 'tenweb-builder' ),
				'type' => Controls_Manager::TEXT,
				'dynamic' => [
					'active' => true,
				],
				'placeholder' => esc_html__( 'Show More', 'tenweb-builder' ),
				'default' => esc_html__( 'Show More', 'tenweb-builder' ),
				'condition' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Read Less Label', 'tenweb-builder' ),
				'type' => Controls_Manager::TEXT,
				'dynamic' => [
					'active' => true,
				],
				'placeholder' => esc_html__( 'Show Less', 'tenweb-builder' ),
				'default' => esc_html__( 'Show Less', 'tenweb-builder' ),
				'condition' => [
					'inner_tab_is_content_collapsible' => 'collapsible',
				],
			]
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Image Overlay', 'tenweb-builder' ),
			]
		);
		...
		$this->add_control(
			'image_overlay',
			[
				'label' => esc_html__( 'Choose Image', 'tenweb-builder' ),
				'type' => Controls_Manager::MEDIA,
				'default' => [
					'url' => Utils::get_placeholder_image_src(),
				],
		...
		$this->add_control(
			'show_play_icon',
			[
				'label' => esc_html__( 'Play Icon', 'tenweb-builder' ),
		...
		$this->add_control(
			'heading_autoplay',
			[
				'label' => esc_html__( 'Autoplay', 'tenweb-builder' ),
		...
		$this->add_control(
			'autoplay_on_load',
			[
				'label' => esc_html__( 'On Load', 'tenweb-builder' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Show', 'tenweb-builder' ),
				'label_off' => esc_html__( 'Hide', 'tenweb-builder' ),
				'frontend_available' => true,
		...
		$this->add_control(
			'autoplay_next',
			[
				'label' => esc_html__( 'Next Up', 'tenweb-builder' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Show', 'tenweb-builder' ),
				'label_off' => esc_html__( 'Hide', 'tenweb-builder' ),
				'frontend_available' => true,
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Indicate Watched', 'tenweb-builder' ),
				'type' => Controls_Manager::SWITCHER,
				'separator' => 'before',
				'frontend_available' => true,
			]
		...
		$this->add_control(
			'show_video_count',
			[
				'label' => esc_html__( 'Video Count', 'tenweb-builder' ),
				'type' => Controls_Manager::SWITCHER,
				'default' => 'yes',
			]
		);
		...
		$this->add_control(
			'show_thumbnail',
			[
				'label' => esc_html__( 'Thumbnails', 'tenweb-builder' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Show', 'tenweb-builder' ),
				'label_off' => esc_html__( 'Hide', 'tenweb-builder' ),
				'default' => 'yes',
		...
		$this->add_control(
			'watched_icon',
			[
				'label' => esc_html__( 'Watched Icon', 'tenweb-builder' ),
				'type' => Controls_Manager::ICONS,
				'fa4compatibility' => 'icon',
				'default' => [
		...
		$this->add_control(
			'lazy_load',
			[
				'label' => esc_html__( 'Lazy Load', 'tenweb-builder' ),
				'type' => Controls_Manager::SWITCHER,
				'separator' => 'before',
				'frontend_available' => true,
			]
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Top Bar', 'tenweb-builder' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Background', 'tenweb-builder' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Videos', 'tenweb-builder' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			'heading_tab_normal',
			[
				'label' => esc_html__( 'Item', 'tenweb-builder' ),
				'type' => Controls_Manager::HEADING,
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Show More', 'tenweb-builder' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
					...
					<div class="e-tabs-header">
						...
						<div class="e-tabs-header-right-side">
							<?php if ( $playlist_object->is_show_video_count ) : ?>
								<span class="e-tabs-videos-count"><?php echo esc_html( $playlist_object->video_count ); ?> <?php echo esc_html__( 'Videos', 'tenweb-builder' ); ?></span>
							<?php endif; ?>
							<?php
								...
								<div class="elementor-custom-embed-image-overlay elementor-clickable" style="background-image: url('<?php echo esc_url( $playlist_object->image_overlay_image ); ?>');">
									<?php if ( ! empty( $playlist_object->image_overlay_icon['value'] ) ) : ?>
										<div class="elementor-custom-embed-play" role="button">
											...
											<span class="elementor-screen-only"><?php echo esc_html__( 'Play Video', 'tenweb-builder' ); ?></span>
										</div>
									<?php endif; ?>
								</div>
							<?php endif; ?>
...
\Elementor\Plugin::instance()->widgets_manager->register( new Video_Playlist() );
