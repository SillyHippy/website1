<?php
namespace Tenweb_Builder\ElementorPro\Modules\LoopBuilder\Widgets;

use Tenweb_Builder\ElementorPro\Modules\LoopBuilder\Documents\Loop as LoopDocument;
use Elementor\Controls_Manager;
use Tenweb_Builder\ElementorPro\Base\Base_Carousel_Trait;
